public class Driver4 {
    public static void main(String[] args) {
        ...
        try {
            list.add(90000, Integer.valueOf(69));
        } catch(IndexOutOfBoundsException B) {
        ...
        try {
            list.set(90000, Integer.valueOf(69));
        } catch(IndexOutOfBoundsException B) {
